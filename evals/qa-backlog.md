...
|----------|-------|--------|
| P0 | 5 | BUG-001, 002, 003, 004, 005 |
| P1 | 5 | BUG-006, 007, 008, 009, 010 |
| P2 | 6 | BUG-011, 012, 013, 014, 015, 016 |
| P3 | 5 | BUG-017, 018, 019, 020, 021 |
| **Total** | **21** | |

**Ship criteria:** All P0 bugs resolved + at least BUG-006, BUG-009 from P1.  
**Re-run HHH eval** after P0+P1 fixes to confirm score clears 90/105.
