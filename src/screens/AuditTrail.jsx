      ...
      <main id="main-content">
        ...
        <div className="adt-doc">
          ...
          <div className="adt-doc-header">
            <div className="adt-doc-header-top">
              ...
              <div className="adt-doc-header-meta">
                ...
                <div className="adt-doc-meta-row"><span>Risk score</span><span>{data.risk_score ?? 62} / 100</span></div>
          ...
          <div className="adt-doc-footer">
            ...
            <span>This document is an AI-generated audit log. Verify all extracted values against the original contract before submission.</span>
          </div>
