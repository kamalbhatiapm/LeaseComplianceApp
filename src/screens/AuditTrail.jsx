      ...
      <main id="main-content">
        ...
        <div className="adt-doc">
          ...
          <div className="adt-doc-footer">
            ...
            <span>AI-assisted, human-reviewed · Powered by OpenAI GPT-5 mini via n8n · Not legal or financial advice · Verify all extracted values against the original contract before submission.</span>
          </div>
